...
class Emp(models.Model):
    ...
    designation = models.ForeignKey(Designation,on_delete=models.SET_DEFAULT,default=None,null=True)
    ...
    photograph_doc = models.FileField( upload_to="uploads/photograph/", max_length=100,blank=True,null=True)
