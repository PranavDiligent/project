...
def product_add(request):
    ...
    if request.user.is_staff:
        if request.method == "POST":
            ...
            purchase_tax_ratee = data["purchase_tax_rate"]
            sale_tax_ratee = data["sale_tax_rate"]
            ...
            purchase_price_tax_rate = purchase_tax_ratee,
            sale_price_tax_rate = sale_tax_ratee,
...
def product_edit(request,id):
    ...
    if request.user.is_staff:
        if request.method == "POST":
            ...
            p.purchase_price_tax_rate = purchase_tax_rate
            p.sale_price_tax_rate = sale_tax_rate
